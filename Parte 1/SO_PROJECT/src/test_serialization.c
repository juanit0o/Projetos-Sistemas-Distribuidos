...
int testDeserializeData(){
    ...
    //printf("data2->datasize: %d\n", data2->datasize);
    //printf("data->data: %p\n", data->data); //problema e aqui
    //printf("data2->data: %p\n", data2->data); //estes dois deviam ser iguais
    //printf("DIFERENCA %d\n\n", memcmp(data->data, data2->data, data->datasize));
...
int testSerializeEntry() {
    ...
    //printf("tamanho %ld\n", sizeof(int) + strlen(entry->key)+1 + sizeof(int) + entry->value->datasize);
